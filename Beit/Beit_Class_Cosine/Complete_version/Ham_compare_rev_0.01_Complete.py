...
def Best_similiars(target_data,sample_data):
        ...
        tfeat1=target_data.iloc[:,2:].reset_index(drop=True).to_numpy()
        ...
        sfeatures1=sample_data.iloc[desrired_classes,2:].to_numpy()
...
cd=featHA(r'C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\sandali.PNG')
