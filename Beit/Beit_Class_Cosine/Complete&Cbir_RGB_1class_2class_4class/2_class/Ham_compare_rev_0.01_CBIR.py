...
cd=featHA(r'C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\airplane.png')
...
#         result= cv2.imread((addi + "//" + sfeature.iloc[j,4]))
...
# sfeature_CB=sfeature_s.iloc[:,1029:].reset_index(drop=True).to_numpy()
# # # print (sfeature_CB.shape,"jadid")
# # # print(tfeat_M.shape,'......')
# tfeat_CB=tfeat_M.iloc[:,1029:].reset_index(drop=True).to_numpy()
