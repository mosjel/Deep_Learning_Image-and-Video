...
class ScrollableImageGallery(tk.Frame):
    ...
    def load_images(self, folder):
        ...
        for file in image_files:
            if file.endswith((".jpg", ".png", ".JPEG")): # Modify this line to match your image file extensions
        ...
        for i, (file, image) in enumerate(images):
            ...
            title.grid(row=i // 3, column=i % 3, padx=3, pady=3, sticky="n") # Add title label above image label
