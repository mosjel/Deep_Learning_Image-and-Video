...
def chi2_distance(a,b, eps=1e-10):
        ...
        return d
cd=featHA(r'C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\fire__.25.PNG')
tfeat_M=cd.resnetfeature()
# print(tfeat_M.shape,'rastaki')
sfeature=pd.read_feather(r'C:\Users\VAIO\Desktop\DSC\PYTHON1\RESNET50\resnet_features_rev_01_test.feather')
...
f = open(r"C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\demofile3_rev_01_test.txt", "r")
addi=f.readline()
addi=addi[:-2]
