...
quer = cv2.imread(r"C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\CBIR1\fire.25.png")
...
# perform the search
searcher = Searcher(r"C:\Users\VAIO\Desktop\DSC\PYTHON1\CBIR\CBIR1\index_H.csv")
...
for i,(score, resultID) in enumerate(results):
	...
	result= cv2.imread(r"C:\\Users\\VAIO\\Desktop\\DSC\\PYTHON1\\CBIR\\CBIR1\\test\\" + resultID)
